...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference("Software.count") do
      post softwares_url, params: { software: { category: @software.category, expires_at: @software.expires_at, name: @software.name } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { category: @software.category, expires_at: @software.expires_at, name: @software.name } }
