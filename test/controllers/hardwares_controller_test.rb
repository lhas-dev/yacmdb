...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference("Hardware.count") do
      post hardwares_url, params: { hardware: { category: @hardware.category, server_id: @hardware.server_id, value: @hardware.value } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { category: @hardware.category, server_id: @hardware.server_id, value: @hardware.value } }
