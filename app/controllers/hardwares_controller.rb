class HardwaresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @hardware.save
        format.html { redirect_to server_url(@hardware.server, tab: "hardware"), notice: "Hardware was successfully created." }
  ...
  def update
    respond_to do |format|
      if @hardware.update(hardware_params)
        format.html { redirect_to server_url(@hardware.server, tab: "hardware"), notice: "Hardware was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to server_url(server, tab: "hardware"), notice: "Hardware was successfully destroyed." }
  ...
  private
    ...
    def hardware_params
      params.require(:hardware).permit(:server_id, :category, :value)
    end
end
